...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(form -> form.defaultSuccessUrl("/users", true));

        // Obliger l'authentification pour toutes les requêtes
